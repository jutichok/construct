...
<head>
	...
	<!--Page CSS -->
	<link href="collectionType.css" rel="stylesheet"/>
	...
	<!-- js -->
	<script type="text/javascript" src="collectionType.js"></script>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">	
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h2 class="page-header">Collection Type</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<input type="button" class="btn btn-default" value="Add Collection Type" id="btnAdd"> 
					</div>
				</div>
			</div>
		</div>

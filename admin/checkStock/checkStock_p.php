...
function getProduct($pageNow,$strSort,$strOrder){
	$str="";
	$uid="";
	$sql = "SELECT prodid,prodname,price,qty,measure,tpy.prodtypename as prodtype FROM tprod tp inner join tprodtype tpy on tpy.prodtypeid = tp.prodtypeid where tp.inShop = '1'";
